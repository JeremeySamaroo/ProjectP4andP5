...
//        boolean testModeSingleForLoop = false;
        ...
        int lastPlayedLast[] = {2,9,8,6};
        int lastPlayedPBeforLast[] = {3,7,8,6};
        int nextPlayed[] = {8,8,4,4};
        String notIn1 = "10";
        String notIn2 = "26";

        CheckP4In checkP5In = new CheckP4In();

        List<ArrayList<P4[]>> listOfP5PossiblePlayableWithOutLastPlayedRemovedPairsGlobal = new ArrayList<>();
        List<P4[]> ppArrayListGlobal = new ArrayList<>();
        List<P4[]> allCombosListGlobal = new ArrayList<>();
...
//        CheckP4In checkP5In = new CheckP4In();
        ...
        P4[] uniqueListArrayGlobal = new P4[0];
        ...
        ArrayList<P4> listAllComboP4 = new ArrayList<>();
        ...
        for(int globalRun = 0; globalRun < globalRunIndex; globalRun++) {
            ...
            int amtCombinations = p4.calculateAmtCombinations(choices);
            now = ZonedDateTime.now(ZoneId.systemDefault());
            ...
            P4 allCombos[] = new P4[amtCombinations];
            allCombos = p4.generateAllCombinations(choices, allCombos);
            ...
            P4 ppArray[] = new P4[lengthOfPossiblePlayable];
...
//            }
            ...
            ArrayList<P4[]> listOfP5PossiblePlayableWithOutLastPlayedRemovedPairs = new ArrayList<>();
            for (int[] arrayInListLastPlayedNumbersWithoutRepeats : listLastPlayedNumbersWithoutRepeats) {
                ...
                P4 ppArrayWithOutLastPlayedRemovedPairs[] = new P4[lengthOfPossiblePlayableWithOutLastPlayedRemovedPairs];
...
//            GetRandomIndex getRandomIndex = new GetRandomIndex();
            ...
            now = ZonedDateTime.now(ZoneId.systemDefault());
            System.out.println("starting get random index listOfP5PossiblePlayableWithOutLastPlayedRemovedPairs.size(): " + listOfP5PossiblePlayableWithOutLastPlayedRemovedPairs.size() + " listOfP5PossiblePlayableWithOutLastPlayedRemovedPairs.getFirst().length: " + listOfP5PossiblePlayableWithOutLastPlayedRemovedPairs.getFirst().length + " at " + now.format(formatter));//+ " with value: "+ Arrays.toString(listOfP5PossiblePlayableWithOutLastPlayedRemovedPairs.getFirst()));
            int arrayOfRandomIndexLength1 = listOfP5PossiblePlayableWithOutLastPlayedRemovedPairs.size();
//        int arrayOfRandomIndexLength1 = 14;
//        System.out.println(arrayOfRandomIndexLength1);
...
//                System.out.println("entering if: "+arrayOfRandomIndexLength1);
...
//            CheckP5In checkP5In = new CheckP5In();
            ...
            System.out.println(arrayOfRandomIndexLength1 + " arrayOfRandomIndex1.length: " + arrayOfRandomIndex1.length);
            ...
            ArrayList<P4[]> listOfP5PossiblePlayableWithOutLastPlayedRemovedPairsTemp = new ArrayList<>();
        ...
        for(List<P4[]> a:listOfP5PossiblePlayableWithOutLastPlayedRemovedPairsGlobal ){
            for(P4[]b:  a){
        ...
        for(int globalRun = 0; globalRun < listOfP5PossiblePlayableWithOutLastPlayedRemovedPairsGlobal.size(); globalRun++) {
            ...
            ArrayList<P4[]> listOfP5PossiblePlayableWithOutLastPlayedRemovedPairs = listOfP5PossiblePlayableWithOutLastPlayedRemovedPairsGlobal.get(globalRun);
            P4[] ppArray = ppArrayListGlobal.get(globalRun);
            P4[] allCombos = allCombosListGlobal.get(globalRun);
            ...
            for (int i = 0; i < listOfP5PossiblePlayableWithOutLastPlayedRemovedPairs.size(); i++) {
                P4[] notInTemp = checkP5In.notInPParray1(ppArray, listOfP5PossiblePlayableWithOutLastPlayedRemovedPairs.get(i));
                now = ZonedDateTime.now(ZoneId.systemDefault());
            ...
            P4[] globalUniqueListArrayArray = new P4[0];
            P4[] dohHaveForSureArray = new P4[0];
            P4[] halfUniqueListArray = new P4[0];
            List<TwoArrayObjects> tempTaoFinal = new ArrayList<>();
            List<TwoArrayObjects> tempTaoFinalEnd = new ArrayList<>();
            List<P4[]> dohHaveList = new ArrayList<>();
            int countWhile = 0;

            //variable holders.
            List<TwoArrayObjects> taoHolder = new ArrayList<>();
            taoHolder = tao;
            P4[] globalUniqueListArrayArrayHolder = new P4[0];

            List<TwoArrayObjects> tempTaoFinalEndHolder = new ArrayList<>();
            List<List<P4[]>> listOfP5ArrayNotInList = new ArrayList<>();
            for (int finalRunTest = 0; finalRunTest < globalRunIndex; finalRunTest++) {
                ...
                P4 arraysOfRandFromPPArrayToCheckHolder[] = new P4[0];
                List<P4[]> p5ArrayNotInList = new ArrayList<>();
                //while (whileRun == true) {
                tao = taoHolder;
                if (finalRunTest != 0) {
                ...
                for (int i = 0; i < tao.size(); i++) {
                    ...
                    if (taoOneNotNull == true && taoTwoNotNull == true) {
                        P4[] notInTemp = checkP5In.notInPParray1(tao.get(i).getTwo(), tao.get(i).getOne(), allCombos, countWhile, nextPlayed);
//                if(countWhile > 0){
//                    notInTemp = new P5[0];
//                    notInTemp = tao.get(i).getTwo();
//                }
                        P4[] notInTempMerged = checkP5In.mergeP4Arrays(tao.get(i).getOne(), notInTemp);
                        if (countWhile > 0) {
                            notInTempMerged = new P4[0];
...
//                        System.out.println("a.getOne().length: " +a.getOne().length+" "+checkP5In.hasValue(a.getOne(), nextPlayed));
                ...
                String fileName = "uniqueValueFile_P4_" + finalRunTest + ".txt";
...
// ============================================================
                        ...
                        while (runCounter < 2) {
                            ...
                            P4[] arraysOfRandFromPPArrayToCheck =
                                    new P4[0];
                            ...
                            while (!checkIfTrue) {
                                ...
                                arraysOfRandFromPPArrayToCheck =
                                        new P4[arrayOfRandomIndex.length];
...
//
                        ...
                        for (
                            ...
                            for (P4[] listOneArray : list1) {

                                for (P4[] listTwoArray : list2) {

                                    List<P4> finalListTemp =
                                            checkP5In.getListOfP4Final(
                                                    listOneArray,
                                                    listTwoArray,
                                                    nextPlayed
                                            );
...
//                    }//end for testIndex
                    ...
                    if (testMode == false && testIndex != 0) {
                        List<P4> listTempUniqueListArray = new ArrayList<>();
                        ...
                        try (BufferedReader reader = new BufferedReader(new FileReader(fileName))) {
                            ...
                            while ((line = reader.readLine()) != null) {
                                ...
                                listTempUniqueListArray.add(new P4(n1, n2, n3, n4, value));
                            }
                        ...
                        uniqueListArray = listTempUniqueListArray.toArray(new P4[0]);
                        ...
                        try (BufferedWriter writer = new BufferedWriter(new FileWriter(fileName))) {
                            ...
                            for (P4 p : uniqueListArrayGlobal) {
                                writer.write(
                                        p.n1 + "," +
                                                p.n2 + "," +
                                                p.n3 + "," +
