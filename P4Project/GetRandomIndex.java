...
public class GetRandomIndex {
    ...
    public int[] GRI(P4[] ppArray, int[] arrayOfRandomIndex) {
    ...
    public int[] GRI1(ArrayList<P4[]> ppArray, int[] arrayOfRandomIndex) {
    ...
    public int[] GRI_HashSet(ArrayList<P4[]> ppArray, int[] arrayOfRandomIndex) {
        Random random = new Random();
    ...
    public int[] GRI_HashSet1(P4[] ppArray, int[] arrayOfRandomIndex) {
        Random random = new Random();
        HashSet<Integer> uniqueIndices = new HashSet<>();
