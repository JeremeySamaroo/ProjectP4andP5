...
public class Step02 {
    ...
    private List<TwoArrayObjects> dividedObject(TwoArrayObjects tempTao) {
        ...
        List<P5[]> listOfArrays = new ArrayList<>();
        ...
        for(int i = 0; i < combined.size(); i++){
            ...
            P5[] toBeCombined2 = combined.get(i).getOne();

            System.out.println("\t\t#:"+i+" toBeCombined1: "+toBeCombined1.length+" toBeCombined2: "+toBeCombined2.length);

            P5[] combinedArray1and2 = new P5[ toBeCombined1.length+ toBeCombined2.length];
...
// Create a temporary array of the adjusted length
        P5[] tempArray = new P5[adjustedLength];
        System.arraycopy(arrayTwo, 0, tempArray, 0, length);
...
// Now combine each
    ...
    private List<TwoArrayObjects> combineListOfArrays(List<P5[]> listOfArrays) {
        ...
        for(int i =0; i < listOfArrays.size(); i++){
            P5[] temp1 = new P5[listOfArrays.get(0).length * 4];
            P5[] temp2 = new P5[listOfArrays.get(0).length];
            int index = 0;
...
//}
    ...
    public static ArrayList<P5[]> divideIntoFive(P5[] array) {
        ArrayList<P5[]> result = new ArrayList<>();
        ...
        for (int i = 0; i < 5; i++) {
            ...
            P5[] subArray = Arrays.copyOfRange(array, start, start + currentSize);
            result.add(subArray);
            start += currentSize;
        }
